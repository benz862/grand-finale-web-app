-- Complete Legacy Planning Application Database Schema - DROP AND RECREATE
-- This SQL file drops all existing tables and creates new ones with the complete structure
...
DROP TABLE IF EXISTS conclusion CASCADE;
DROP TABLE IF EXISTS formal_letters CASCADE;
DROP TABLE IF EXISTS bucket_list_unfinished_business CASCADE;
DROP TABLE IF EXISTS key_contacts CASCADE;
DROP TABLE IF EXISTS accounts_memberships CASCADE;
DROP TABLE IF EXISTS digital_life CASCADE;
DROP TABLE IF EXISTS beneficiaries_inheritance CASCADE;
DROP TABLE IF EXISTS personal_property_real_estate CASCADE;
DROP TABLE IF EXISTS funeral_preferences CASCADE;
DROP TABLE IF EXISTS financial_info CASCADE;
DROP TABLE IF EXISTS medical_info CASCADE;
DROP TABLE IF EXISTS file_uploads_multimedia CASCADE;
DROP TABLE IF EXISTS transition_notes CASCADE;
DROP TABLE IF EXISTS short_letters CASCADE;
DROP TABLE IF EXISTS pets_animal_care CASCADE;
DROP TABLE IF EXISTS final_wishes_legacy_planning CASCADE;
DROP TABLE IF EXISTS legal_estate CASCADE;
