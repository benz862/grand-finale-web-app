    ...
    var body: some View {
        GeometryReader { geometry in
            ZStack {
                ...
                // Debug background to see if view is working
    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: false) {
            VStack(spacing: 20) {
                ...
                Text(script.isEmpty ? "No script loaded. Go to Scripts tab to add content." : script)
                    .font(.system(size: fontSize, weight: .medium, design: .rounded))
                    .foregroundColor(textColor)
                    .multilineTextAlignment(.center)
                    .lineSpacing(8)
                    .padding(.horizontal, 40)
                    .background(Color.black.opacity(0.1)) // Slight background for visibility
                    .mask(
