...
interface IntroductionFormFixedProps {
  onNext: () => void;
}

const IntroductionFormFixed: React.FC<IntroductionFormFixedProps> = ({ onNext }) => {
    ...
    <>
      ...
      <Card>
        <CardHeader className="text-center">
          <CardTitle className="font-bold text-skillbinder-yellow text-3xl">Welcome to The Grand Finale</CardTitle>
...
export default IntroductionFormFixed;
